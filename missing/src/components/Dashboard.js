...
export default function Dashboard() {
    const [filmData, setFilmData] = useState(null); // Track the film data to pass to ModalCase
  ...
  const handleClose = () => {
    ...
    const deleteMovies = (id) => {
        fetch(`https://653740ccbb226bb85dd2fd5c.mockapi.io/films/${id}`, {
            method: 'DELETE'
        })
            .then((result) => {
    ...
    return (
        <div>
            ...
            <div className="dashboard">
                        ...
                        <TableBody>
                            {APIData.map((data) => (
                                ...
                                >
                                    ...
                                    <TableCell>
                                        <a
                                            onClick={() => {
                                                ...
                                                setFilmData(data); // Pass film data to ModalCase
                                                setIsOpen(true);
                                            }}
                                        >
                                            Open
                                    ...
                                    <TableCell><Button><DeleteIcon style={{ color: 'red' }} onClick={() => setOpen(true)} /></Button></TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
                ...
                {APIData.map((film) => (
                    ...
                    >
                        ...
                        <DialogActions>
                            <Button onClick={() => deleteMovies(film.id)} style={{ color: 'red' }}>Yes</Button>
            ...
            {filmData && (
        <ModalCase isOpen={isOpen} setIsOpen={setIsOpen} film={filmData} />
      )}
        </div>
    )
}